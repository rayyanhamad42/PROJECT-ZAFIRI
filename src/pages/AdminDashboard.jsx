...
import {
  ...
  FaSignOutAlt,
  FaBuilding,
  FaHistory, // Added missing import
} from "react-icons/fa";
...
const AdminDashboard = () => {
  ...
  const overviewData = [
    { id: 1, type: 'Sample', name: 'Mwani Sample X', customer: 'Alice Brown', status: 'Pending', date: '2025-08-12' },
    { id: 2, type: 'Test', name: 'Mwani Test Y', technician: 'Jane Doe', status: 'Awaiting Approval', date: '2025-08-11' },
    { id: 3, type: 'User', name: 'John Smith', role: 'Lab Technician', status: 'Active', date: '2025-08-10' },
  ];
